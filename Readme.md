...
## Актуальные версии:
 - `Lotus.Windows` - проект протестирован, актуальная версия **3.1.0** от **29.12.2024**, загружено на github и Nuget
 - `Lotus.Windows.UI` - проект протестирован, актуальная версия **3.1.0** от **29.12.2024**, загружено на github и Nuget
 - `Lotus.Windows.ViewerContent3D` - проект протестирован, актуальная версия **3.1.0** от **29.12.2024**, загружено на github
 - `Lotus.Windows.ViewerImage` - проект протестирован, актуальная версия **3.1.0** от **29.12.2024**, загружено на github
 - `Lotus.Windows.ViewerText` - проект протестирован, актуальная версия **3.1.0** от **29.12.2024**, загружено на github

## Зависит от:
 - Lotus.Core, версия 3.1.0
 - Lotus.Math, версия 3.1.0
